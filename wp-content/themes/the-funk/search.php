		...
		<main class="content">
			<div class="timeline_items_wrapper">
				<div class="postwrap postwrapBlog tl2">
					<?php if (have_posts()) : ?>
						<h2 style="padding-left: 20px;"><?php _e( 'Search results for:', 'the-funk' ); ?> <?php echo get_search_query(); ?></h2>
					...
					<?php  else : ?>
						<div class="entry">
							<h1 class="title"><?php _e( 'Search results for:', 'the-funk' ); ?> <?php echo get_search_query(); ?></h1>
